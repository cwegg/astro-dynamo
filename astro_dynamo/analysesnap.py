...
def patternspeed(snap, rrange=(1, 4), n=range(2, 12, 2), combine=True, plot=None):
    """Compute the pattern speed of a snapshot. Uses continuuty equation in cylindrical coordinates. Integrating over
...
def interplen(r, vals, lim, ifid, comp='lt'):
    ...
    Use either comp='lt' or comp='lt' to decide in which direction to fin the crossing. ifid should be an index point
